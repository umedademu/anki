...
if (!html.includes('<script src="/app.js?v=0.272" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.272") ||
  !app.includes("app-navigation.js?v=0.272") ||
  !changelog.includes("v0.272") ||
  !settingsHtml.includes("v0.272") ||
  !historyHtml.includes("v0.272") ||
  !analysisHtml.includes("v0.272")
) {
...
if (
  !html.includes('href="/styles.css?v=0.272"') ||
