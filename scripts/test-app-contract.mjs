...
if (!html.includes('<script src="/app.js?v=0.226" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.226") ||
  !app.includes("v0.226｜") ||
  !changelog.includes("v0.226") ||
  !settingsHtml.includes("v0.226") ||
  !historyHtml.includes("v0.226") ||
  !analysisHtml.includes("v0.226")
) {
...
if (
  !html.includes('href="/styles.css?v=0.226"') ||
