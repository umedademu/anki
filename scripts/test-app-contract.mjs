...
if (!html.includes('<script src="/app.js?v=0.263" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.263") ||
  !app.includes("app-navigation.js?v=0.263") ||
  !changelog.includes("v0.263") ||
  !settingsHtml.includes("v0.263") ||
  !historyHtml.includes("v0.263") ||
  !analysisHtml.includes("v0.263")
) {
...
if (
  !html.includes('href="/styles.css?v=0.263"') ||
