...
if (!html.includes('<script src="/app.js?v=0.256" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.256") ||
  !app.includes("app-navigation.js?v=0.256") ||
  !changelog.includes("v0.256") ||
  !settingsHtml.includes("v0.256") ||
  !historyHtml.includes("v0.256") ||
  !analysisHtml.includes("v0.256")
) {
...
if (
  !html.includes('href="/styles.css?v=0.256"') ||
