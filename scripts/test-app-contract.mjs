...
if (!html.includes('<script src="/app.js?v=0.158" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.158") ||
  !app.includes("v0.158｜") ||
  !changelog.includes("v0.158") ||
  !settingsHtml.includes("v0.158") ||
  !historyHtml.includes("v0.158")
) {
...
if (
  !html.includes('href="/styles.css?v=0.158"') ||
