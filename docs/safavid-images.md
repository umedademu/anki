...
| cannon | 大砲（火器部隊の象徴） |
| ottoman-gunner | オスマン鉄砲兵（イェニチェリ銃兵・白帽・マスケット銃を構えて煙を吹く） |
| cannon-firing | 砲煙を上げる大砲（発射炎と白い砲煙を噴き出す大砲） |
| qizilbash-cavalry | キジルバシュ騎兵（赤帽・馬に乗って曲刀を掲げる騎馬戦士） |
| ottoman-infantry | オスマン歩兵（槍と盾を構えるオスマン兵） |

上記の名前に `.png` を付けたファイルを保存。
v0.188にて、チャルディラーンの戦いにおけるオスマン軍の「鉄砲・大砲」の視覚的表現を強化するため、イェニチェリ銃兵および砲煙を上げる大砲、さらにキジルバシュ騎兵を追加実装した。
