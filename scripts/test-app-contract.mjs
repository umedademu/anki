...
if (!html.includes('<script src="/app.js?v=0.196" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.196") ||
  !app.includes("v0.196｜") ||
  !changelog.includes("v0.196") ||
  !settingsHtml.includes("v0.196") ||
  !historyHtml.includes("v0.196") ||
  !analysisHtml.includes("v0.196")
) {
...
if (
  !html.includes('href="/styles.css?v=0.196"') ||
