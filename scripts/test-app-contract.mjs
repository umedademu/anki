...
if (!html.includes('<script src="/app.js?v=0.197" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.197") ||
  !app.includes("v0.197｜") ||
  !changelog.includes("v0.197") ||
  !settingsHtml.includes("v0.197") ||
  !historyHtml.includes("v0.197") ||
  !analysisHtml.includes("v0.197")
) {
...
if (
  !html.includes('href="/styles.css?v=0.197"') ||
