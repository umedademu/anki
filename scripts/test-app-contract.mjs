...
if (!html.includes('<script src="/app.js?v=0.254" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.254") ||
  !app.includes("app-navigation.js?v=0.254") ||
  !changelog.includes("v0.254") ||
  !settingsHtml.includes("v0.254") ||
  !historyHtml.includes("v0.254") ||
  !analysisHtml.includes("v0.254")
) {
...
if (
  !html.includes('href="/styles.css?v=0.254"') ||
