...
if (!html.includes('<script src="/app.js?v=0.199" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.199") ||
  !app.includes("v0.199｜") ||
  !changelog.includes("v0.199") ||
  !settingsHtml.includes("v0.199") ||
  !historyHtml.includes("v0.199") ||
  !analysisHtml.includes("v0.199")
) {
...
if (
  !html.includes('href="/styles.css?v=0.199"') ||
