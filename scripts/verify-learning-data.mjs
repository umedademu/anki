...
if (
  ...
  mindsetSubjectEntry.termCount !== 119 ||
...
if (
  ...
  new Set(generatedMindsetTerms.map((term) => term.id)).size !== 119 ||
  new Set(generatedMindsetTerms.map((term) => term.content)).size !== 119 ||
  ...
  throw new Error("マインドセット119件の生成内容が元データと一致しません。");
}
