...
if (!html.includes('<script src="/app.js?v=0.221" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.221") ||
  !app.includes("v0.221｜") ||
  !changelog.includes("v0.221") ||
  !settingsHtml.includes("v0.221") ||
  !historyHtml.includes("v0.221") ||
  !analysisHtml.includes("v0.221")
) {
...
if (
  !html.includes('href="/styles.css?v=0.221"') ||
