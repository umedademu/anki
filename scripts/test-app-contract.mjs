...
if (!html.includes('<script src="/app.js?v=0.266" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.266") ||
  !app.includes("app-navigation.js?v=0.266") ||
  !changelog.includes("v0.266") ||
  !settingsHtml.includes("v0.266") ||
  !historyHtml.includes("v0.266") ||
  !analysisHtml.includes("v0.266")
) {
...
if (
  !html.includes('href="/styles.css?v=0.266"') ||
