...
if (!html.includes('<script src="/app.js?v=0.208" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.208") ||
  !app.includes("v0.208｜") ||
  !changelog.includes("v0.208") ||
  !settingsHtml.includes("v0.208") ||
  !historyHtml.includes("v0.208") ||
  !analysisHtml.includes("v0.208")
) {
...
if (
  !html.includes('href="/styles.css?v=0.208"') ||
