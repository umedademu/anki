...
if (!html.includes('<script src="/app.js?v=0.276" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.276") ||
  !app.includes("app-navigation.js?v=0.276") ||
  !changelog.includes("v0.276") ||
  !settingsHtml.includes("v0.276") ||
  !historyHtml.includes("v0.276") ||
  !analysisHtml.includes("v0.276")
) {
...
if (
  !html.includes('href="/styles.css?v=0.276"') ||
