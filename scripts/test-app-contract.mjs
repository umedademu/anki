...
if (!html.includes('<script src="/app.js?v=0.253" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.253") ||
  !app.includes("app-navigation.js?v=0.253") ||
  !changelog.includes("v0.253") ||
  !settingsHtml.includes("v0.253") ||
  !historyHtml.includes("v0.253") ||
  !analysisHtml.includes("v0.253")
) {
...
if (
  !html.includes('href="/styles.css?v=0.253"') ||
