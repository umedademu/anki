...
if (!html.includes('<script src="/app.js?v=0.202" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.202") ||
  !app.includes("v0.202｜") ||
  !changelog.includes("v0.202") ||
  !settingsHtml.includes("v0.202") ||
  !historyHtml.includes("v0.202") ||
  !analysisHtml.includes("v0.202")
) {
...
if (
  !html.includes('href="/styles.css?v=0.202"') ||
