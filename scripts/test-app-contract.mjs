...
if (!html.includes('<script src="/app.js?v=0.271" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.271") ||
  !app.includes("app-navigation.js?v=0.271") ||
  !changelog.includes("v0.271") ||
  !settingsHtml.includes("v0.271") ||
  !historyHtml.includes("v0.271") ||
  !analysisHtml.includes("v0.271")
) {
...
if (
  !html.includes('href="/styles.css?v=0.271"') ||
