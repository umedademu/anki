...
if (!html.includes('<script src="/app.js?v=0.268" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.268") ||
  !app.includes("app-navigation.js?v=0.268") ||
  !changelog.includes("v0.268") ||
  !settingsHtml.includes("v0.268") ||
  !historyHtml.includes("v0.268") ||
  !analysisHtml.includes("v0.268")
) {
...
if (
  !html.includes('href="/styles.css?v=0.268"') ||
