...
if (!html.includes('<script src="/app.js?v=0.157" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.157") ||
  !app.includes("v0.157｜") ||
  !changelog.includes("v0.157") ||
  !settingsHtml.includes("v0.157") ||
  !historyHtml.includes("v0.157")
) {
...
if (
  !html.includes('href="/styles.css?v=0.157"') ||
