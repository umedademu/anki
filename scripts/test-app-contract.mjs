...
if (!html.includes('<script src="/app.js?v=0.262" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.262") ||
  !app.includes("app-navigation.js?v=0.262") ||
  !changelog.includes("v0.262") ||
  !settingsHtml.includes("v0.262") ||
  !historyHtml.includes("v0.262") ||
  !analysisHtml.includes("v0.262")
) {
...
if (
  !html.includes('href="/styles.css?v=0.262"') ||
