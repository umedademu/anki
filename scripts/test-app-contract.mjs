...
if (!html.includes('<script src="/app.js?v=0.192" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.192") ||
  !app.includes("v0.192｜") ||
  !changelog.includes("v0.192") ||
  !settingsHtml.includes("v0.192") ||
  !historyHtml.includes("v0.192") ||
  !analysisHtml.includes("v0.192")
) {
...
if (
  !html.includes('href="/styles.css?v=0.192"') ||
