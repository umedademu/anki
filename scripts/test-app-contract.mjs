...
if (!html.includes('<script src="/app.js?v=0.182" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.182") ||
  !app.includes("v0.182｜") ||
  !changelog.includes("v0.182") ||
  !settingsHtml.includes("v0.182") ||
  !historyHtml.includes("v0.182") ||
  !analysisHtml.includes("v0.182")
) {
...
if (
  !html.includes('href="/styles.css?v=0.182"') ||
