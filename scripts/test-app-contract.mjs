...
if (!html.includes('<script src="/app.js?v=0.265" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.265") ||
  !app.includes("app-navigation.js?v=0.265") ||
  !changelog.includes("v0.265") ||
  !settingsHtml.includes("v0.265") ||
  !historyHtml.includes("v0.265") ||
  !analysisHtml.includes("v0.265")
) {
...
if (
  !html.includes('href="/styles.css?v=0.265"') ||
