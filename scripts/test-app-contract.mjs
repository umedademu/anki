...
if (!html.includes('<script src="/app.js?v=0.247" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.247") ||
  !app.includes("v0.247｜") ||
  !changelog.includes("v0.247") ||
  !settingsHtml.includes("v0.247") ||
  !historyHtml.includes("v0.247") ||
  !analysisHtml.includes("v0.247")
) {
...
if (
  !html.includes('href="/styles.css?v=0.247"') ||
