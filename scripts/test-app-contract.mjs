...
if (!html.includes('<script src="/app.js?v=0.269" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.269") ||
  !app.includes("app-navigation.js?v=0.269") ||
  !changelog.includes("v0.269") ||
  !settingsHtml.includes("v0.269") ||
  !historyHtml.includes("v0.269") ||
  !analysisHtml.includes("v0.269")
) {
...
if (
  !html.includes('href="/styles.css?v=0.269"') ||
