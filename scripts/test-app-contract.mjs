...
if (!html.includes('<script src="/app.js?v=0.225" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.225") ||
  !app.includes("v0.225｜") ||
  !changelog.includes("v0.225") ||
  !settingsHtml.includes("v0.225") ||
  !historyHtml.includes("v0.225") ||
  !analysisHtml.includes("v0.225")
) {
...
if (
  !html.includes('href="/styles.css?v=0.225"') ||
