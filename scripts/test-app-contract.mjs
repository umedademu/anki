...
if (!html.includes('<script src="/app.js?v=0.220" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.220") ||
  !app.includes("v0.220｜") ||
  !changelog.includes("v0.220") ||
  !settingsHtml.includes("v0.220") ||
  !historyHtml.includes("v0.220") ||
  !analysisHtml.includes("v0.220")
) {
...
if (
  !html.includes('href="/styles.css?v=0.220"') ||
