...
if (!html.includes('<script src="/app.js?v=0.213" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.213") ||
  !app.includes("v0.213｜") ||
  !changelog.includes("v0.213") ||
  !settingsHtml.includes("v0.213") ||
  !historyHtml.includes("v0.213") ||
  !analysisHtml.includes("v0.213")
) {
...
if (
  !html.includes('href="/styles.css?v=0.213"') ||
