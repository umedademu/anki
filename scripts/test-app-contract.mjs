...
if (!html.includes('<script src="/app.js?v=0.214" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.214") ||
  !app.includes("v0.214｜") ||
  !changelog.includes("v0.214") ||
  !settingsHtml.includes("v0.214") ||
  !historyHtml.includes("v0.214") ||
  !analysisHtml.includes("v0.214")
) {
...
if (
  !html.includes('href="/styles.css?v=0.214"') ||
