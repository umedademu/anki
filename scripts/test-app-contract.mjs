...
if (!html.includes('<script src="/app.js?v=0.264" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.264") ||
  !app.includes("app-navigation.js?v=0.264") ||
  !changelog.includes("v0.264") ||
  !settingsHtml.includes("v0.264") ||
  !historyHtml.includes("v0.264") ||
  !analysisHtml.includes("v0.264")
) {
...
if (
  !html.includes('href="/styles.css?v=0.264"') ||
