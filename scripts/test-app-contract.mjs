...
if (!html.includes('<script src="/app.js?v=0.231" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.231") ||
  !app.includes("v0.231｜") ||
  !changelog.includes("v0.231") ||
  !settingsHtml.includes("v0.231") ||
  !historyHtml.includes("v0.231") ||
  !analysisHtml.includes("v0.231")
) {
...
if (
  !html.includes('href="/styles.css?v=0.231"') ||
