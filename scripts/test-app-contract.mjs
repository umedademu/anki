...
if (!html.includes('<script src="/app.js?v=0.222" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.222") ||
  !app.includes("v0.222｜") ||
  !changelog.includes("v0.222") ||
  !settingsHtml.includes("v0.222") ||
  !historyHtml.includes("v0.222") ||
  !analysisHtml.includes("v0.222")
) {
...
if (
  !html.includes('href="/styles.css?v=0.222"') ||
