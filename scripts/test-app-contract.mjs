...
if (!html.includes('<script src="/app.js?v=0.241" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.241") ||
  !app.includes("v0.241｜") ||
  !changelog.includes("v0.241") ||
  !settingsHtml.includes("v0.241") ||
  !historyHtml.includes("v0.241") ||
  !analysisHtml.includes("v0.241")
) {
...
if (
  !html.includes('href="/styles.css?v=0.241"') ||
