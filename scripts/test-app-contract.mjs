...
if (!html.includes('<script src="/app.js?v=0.252" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.252") ||
  !app.includes("app-navigation.js?v=0.252") ||
  !changelog.includes("v0.252") ||
  !settingsHtml.includes("v0.252") ||
  !historyHtml.includes("v0.252") ||
  !analysisHtml.includes("v0.252")
) {
...
if (
  !html.includes('href="/styles.css?v=0.252"') ||
