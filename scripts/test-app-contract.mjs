...
if (!html.includes('<script src="/app.js?v=0.183" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.183") ||
  !app.includes("v0.183｜") ||
  !changelog.includes("v0.183") ||
  !settingsHtml.includes("v0.183") ||
  !historyHtml.includes("v0.183") ||
  !analysisHtml.includes("v0.183")
) {
...
if (
  !html.includes('href="/styles.css?v=0.183"') ||
