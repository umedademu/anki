...
if (!html.includes('<script src="/app.js?v=0.274" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.274") ||
  !app.includes("app-navigation.js?v=0.274") ||
  !changelog.includes("v0.274") ||
  !settingsHtml.includes("v0.274") ||
  !historyHtml.includes("v0.274") ||
  !analysisHtml.includes("v0.274")
) {
...
if (
  !html.includes('href="/styles.css?v=0.274"') ||
