...
if (!html.includes('<script src="/app.js?v=0.237" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.237") ||
  !app.includes("v0.237｜") ||
  !changelog.includes("v0.237") ||
  !settingsHtml.includes("v0.237") ||
  !historyHtml.includes("v0.237") ||
  !analysisHtml.includes("v0.237")
) {
...
if (
  !html.includes('href="/styles.css?v=0.237"') ||
