...
if (!html.includes('<script src="/app.js?v=0.203" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.203") ||
  !app.includes("v0.203｜") ||
  !changelog.includes("v0.203") ||
  !settingsHtml.includes("v0.203") ||
  !historyHtml.includes("v0.203") ||
  !analysisHtml.includes("v0.203")
) {
...
if (
  !html.includes('href="/styles.css?v=0.203"') ||
