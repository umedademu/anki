...
if (!html.includes('<script src="/app.js?v=0.181" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.181") ||
  !app.includes("v0.181｜") ||
  !changelog.includes("v0.181") ||
  !settingsHtml.includes("v0.181") ||
  !historyHtml.includes("v0.181") ||
  !analysisHtml.includes("v0.181")
) {
...
if (
  !html.includes('href="/styles.css?v=0.181"') ||
