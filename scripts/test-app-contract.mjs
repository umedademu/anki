...
if (!html.includes('<script src="/app.js?v=0.194" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.194") ||
  !app.includes("v0.194｜") ||
  !changelog.includes("v0.194") ||
  !settingsHtml.includes("v0.194") ||
  !historyHtml.includes("v0.194") ||
  !analysisHtml.includes("v0.194")
) {
...
if (
  !html.includes('href="/styles.css?v=0.194"') ||
