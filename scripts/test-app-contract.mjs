...
if (!html.includes('<script src="/app.js?v=0.234" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.234") ||
  !app.includes("v0.234｜") ||
  !changelog.includes("v0.234") ||
  !settingsHtml.includes("v0.234") ||
  !historyHtml.includes("v0.234") ||
  !analysisHtml.includes("v0.234")
) {
...
if (
  !html.includes('href="/styles.css?v=0.234"') ||
