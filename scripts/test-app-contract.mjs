...
if (!html.includes('<script src="/app.js?v=0.267" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.267") ||
  !app.includes("app-navigation.js?v=0.267") ||
  !changelog.includes("v0.267") ||
  !settingsHtml.includes("v0.267") ||
  !historyHtml.includes("v0.267") ||
  !analysisHtml.includes("v0.267")
) {
...
if (
  !html.includes('href="/styles.css?v=0.267"') ||
