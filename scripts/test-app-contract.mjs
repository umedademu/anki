...
if (!html.includes('<script src="/app.js?v=0.245" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.245") ||
  !app.includes("v0.245｜") ||
  !changelog.includes("v0.245") ||
  !settingsHtml.includes("v0.245") ||
  !historyHtml.includes("v0.245") ||
  !analysisHtml.includes("v0.245")
) {
...
if (
  !html.includes('href="/styles.css?v=0.245"') ||
