...
if (
  ...
  mindsetSubjectEntry.termCount !== 117 ||
...
if (
  ...
  new Set(generatedMindsetTerms.map((term) => term.id)).size !== 117 ||
  new Set(generatedMindsetTerms.map((term) => term.content)).size !== 117 ||
  ...
  throw new Error("マインドセット117件の生成内容が元データと一致しません。");
}
