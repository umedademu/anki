...
if (!html.includes('<script src="/app.js?v=0.273" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.273") ||
  !app.includes("app-navigation.js?v=0.273") ||
  !changelog.includes("v0.273") ||
  !settingsHtml.includes("v0.273") ||
  !historyHtml.includes("v0.273") ||
  !analysisHtml.includes("v0.273")
) {
...
if (
  !html.includes('href="/styles.css?v=0.273"') ||
