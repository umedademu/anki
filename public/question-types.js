...
export function resolveQuestionTypes(value, excludeTimeQuestions = true, additionalTypes = []) {
  return Array.isArray(value) ? value : [...Object.keys(questionTypes), ...additionalTypes].filter(type => !excludeTimeQuestions || type !== "time");
}
