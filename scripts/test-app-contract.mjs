...
if (!html.includes('<script src="/app.js?v=0.255" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.255") ||
  !app.includes("app-navigation.js?v=0.255") ||
  !changelog.includes("v0.255") ||
  !settingsHtml.includes("v0.255") ||
  !historyHtml.includes("v0.255") ||
  !analysisHtml.includes("v0.255")
) {
...
if (
  !html.includes('href="/styles.css?v=0.255"') ||
