...
if (!html.includes('<script src="/app.js?v=0.239" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.239") ||
  !app.includes("v0.239｜") ||
  !changelog.includes("v0.239") ||
  !settingsHtml.includes("v0.239") ||
  !historyHtml.includes("v0.239") ||
  !analysisHtml.includes("v0.239")
) {
...
if (
  !html.includes('href="/styles.css?v=0.239"') ||
