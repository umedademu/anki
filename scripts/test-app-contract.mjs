...
if (!html.includes('<script src="/app.js?v=0.201" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.201") ||
  !app.includes("v0.201｜") ||
  !changelog.includes("v0.201") ||
  !settingsHtml.includes("v0.201") ||
  !historyHtml.includes("v0.201") ||
  !analysisHtml.includes("v0.201")
) {
...
if (
  !html.includes('href="/styles.css?v=0.201"') ||
