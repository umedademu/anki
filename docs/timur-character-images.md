...
v0.183（2026年9月5日）で、人物を地図内へ移し、図形で描いていた人物を透過PNGへ置き換えた。

## 作成方法と保存先

内蔵の画像生成を使用。約3頭身のファミコン風ドット絵を、表情違いも含めた4列×4行の人物画像集として一度に生成した。背景の透明度を保持し、画像集の各升目を切り出して128×192画素へ最近傍方式で縮小した。生成時の大きさは1024×1536画素。読み込み時に画像生成への通信は発生しない。
