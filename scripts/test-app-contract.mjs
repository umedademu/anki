...
if (!html.includes('<script src="/app.js?v=0.210" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.210") ||
  !app.includes("v0.210｜") ||
  !changelog.includes("v0.210") ||
  !settingsHtml.includes("v0.210") ||
  !historyHtml.includes("v0.210") ||
  !analysisHtml.includes("v0.210")
) {
...
if (
  !html.includes('href="/styles.css?v=0.210"') ||
