...
if (!html.includes('<script src="/app.js?v=0.251" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.251") ||
  !app.includes("app-navigation.js?v=0.251") ||
  !changelog.includes("v0.251") ||
  !settingsHtml.includes("v0.251") ||
  !historyHtml.includes("v0.251") ||
  !analysisHtml.includes("v0.251")
) {
...
if (
  !html.includes('href="/styles.css?v=0.251"') ||
