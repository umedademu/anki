...
if (!html.includes('<script src="/app.js?v=0.211" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.211") ||
  !app.includes("v0.211｜") ||
  !changelog.includes("v0.211") ||
  !settingsHtml.includes("v0.211") ||
  !historyHtml.includes("v0.211") ||
  !analysisHtml.includes("v0.211")
) {
...
if (
  !html.includes('href="/styles.css?v=0.211"') ||
