...
if (!html.includes('<script src="/app.js?v=0.218" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.218") ||
  !app.includes("v0.218｜") ||
  !changelog.includes("v0.218") ||
  !settingsHtml.includes("v0.218") ||
  !historyHtml.includes("v0.218") ||
  !analysisHtml.includes("v0.218")
) {
...
if (
  !html.includes('href="/styles.css?v=0.218"') ||
