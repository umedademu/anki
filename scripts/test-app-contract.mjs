...
if (!html.includes('<script src="/app.js?v=0.238" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.238") ||
  !app.includes("v0.238｜") ||
  !changelog.includes("v0.238") ||
  !settingsHtml.includes("v0.238") ||
  !historyHtml.includes("v0.238") ||
  !analysisHtml.includes("v0.238")
) {
...
if (
  !html.includes('href="/styles.css?v=0.238"') ||
