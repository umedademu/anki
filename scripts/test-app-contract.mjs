...
if (!html.includes('<script src="/app.js?v=0.227" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.227") ||
  !app.includes("v0.227｜") ||
  !changelog.includes("v0.227") ||
  !settingsHtml.includes("v0.227") ||
  !historyHtml.includes("v0.227") ||
  !analysisHtml.includes("v0.227")
) {
...
if (
  !html.includes('href="/styles.css?v=0.227"') ||
