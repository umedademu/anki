...
if (!html.includes('<script src="/app.js?v=0.244" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.244") ||
  !app.includes("v0.244｜") ||
  !changelog.includes("v0.244") ||
  !settingsHtml.includes("v0.244") ||
  !historyHtml.includes("v0.244") ||
  !analysisHtml.includes("v0.244")
) {
...
if (
  !html.includes('href="/styles.css?v=0.244"') ||
