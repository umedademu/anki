...
if (!html.includes('<script src="/app.js?v=0.275" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.275") ||
  !app.includes("app-navigation.js?v=0.275") ||
  !changelog.includes("v0.275") ||
  !settingsHtml.includes("v0.275") ||
  !historyHtml.includes("v0.275") ||
  !analysisHtml.includes("v0.275")
) {
...
if (
  !html.includes('href="/styles.css?v=0.275"') ||
