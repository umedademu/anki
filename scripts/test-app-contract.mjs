...
if (!html.includes('<script src="/app.js?v=0.205" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.205") ||
  !app.includes("v0.205｜") ||
  !changelog.includes("v0.205") ||
  !settingsHtml.includes("v0.205") ||
  !historyHtml.includes("v0.205") ||
  !analysisHtml.includes("v0.205")
) {
...
if (
  !html.includes('href="/styles.css?v=0.205"') ||
