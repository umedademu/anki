...
if (!html.includes('<script src="/app.js?v=0.246" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.246") ||
  !app.includes("v0.246｜") ||
  !changelog.includes("v0.246") ||
  !settingsHtml.includes("v0.246") ||
  !historyHtml.includes("v0.246") ||
  !analysisHtml.includes("v0.246")
) {
...
if (
  !html.includes('href="/styles.css?v=0.246"') ||
