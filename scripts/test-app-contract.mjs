...
if (!html.includes('<script src="/app.js?v=0.161" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.161") ||
  !app.includes("v0.161｜") ||
  !changelog.includes("v0.161") ||
  !settingsHtml.includes("v0.161") ||
  !historyHtml.includes("v0.161")
) {
...
if (
  !html.includes('href="/styles.css?v=0.161"') ||
