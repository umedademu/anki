...
if (!html.includes('<script src="/app.js?v=0.250" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.250") ||
  !app.includes("app-navigation.js?v=0.250") ||
  !changelog.includes("v0.250") ||
  !settingsHtml.includes("v0.250") ||
  !historyHtml.includes("v0.250") ||
  !analysisHtml.includes("v0.250")
) {
...
if (
  !html.includes('href="/styles.css?v=0.250"') ||
