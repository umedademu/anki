...
if (!html.includes('<script src="/app.js?v=0.243" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.243") ||
  !app.includes("v0.243｜") ||
  !changelog.includes("v0.243") ||
  !settingsHtml.includes("v0.243") ||
  !historyHtml.includes("v0.243") ||
  !analysisHtml.includes("v0.243")
) {
...
if (
  !html.includes('href="/styles.css?v=0.243"') ||
