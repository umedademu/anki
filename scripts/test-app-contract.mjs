...
if (!html.includes('<script src="/app.js?v=0.212" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.212") ||
  !app.includes("v0.212｜") ||
  !changelog.includes("v0.212") ||
  !settingsHtml.includes("v0.212") ||
  !historyHtml.includes("v0.212") ||
  !analysisHtml.includes("v0.212")
) {
...
if (
  !html.includes('href="/styles.css?v=0.212"') ||
