...
if (!html.includes('<script src="/app.js?v=0.191" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.191") ||
  !app.includes("v0.191｜") ||
  !changelog.includes("v0.191") ||
  !settingsHtml.includes("v0.191") ||
  !historyHtml.includes("v0.191") ||
  !analysisHtml.includes("v0.191")
) {
...
if (
  !html.includes('href="/styles.css?v=0.191"') ||
