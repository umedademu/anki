...
if (!html.includes('<script src="/app.js?v=0.200" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.200") ||
  !app.includes("v0.200｜") ||
  !changelog.includes("v0.200") ||
  !settingsHtml.includes("v0.200") ||
  !historyHtml.includes("v0.200") ||
  !analysisHtml.includes("v0.200")
) {
...
if (
  !html.includes('href="/styles.css?v=0.200"') ||
