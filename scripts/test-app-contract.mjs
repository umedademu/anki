...
if (!html.includes('<script src="/app.js?v=0.240" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.240") ||
  !app.includes("v0.240｜") ||
  !changelog.includes("v0.240") ||
  !settingsHtml.includes("v0.240") ||
  !historyHtml.includes("v0.240") ||
  !analysisHtml.includes("v0.240")
) {
...
if (
  !html.includes('href="/styles.css?v=0.240"') ||
...
if (
  ...
  !startBlock.includes('returnParams.get("subject")') ||
  !startBlock.includes("if (returnSubject &&") ||
