...
if (!html.includes('<script src="/app.js?v=0.207" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.207") ||
  !app.includes("v0.207｜") ||
  !changelog.includes("v0.207") ||
  !settingsHtml.includes("v0.207") ||
  !historyHtml.includes("v0.207") ||
  !analysisHtml.includes("v0.207")
) {
...
if (
  !html.includes('href="/styles.css?v=0.207"') ||
