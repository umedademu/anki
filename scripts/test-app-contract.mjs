...
if (!html.includes('<script src="/app.js?v=0.235" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.235") ||
  !app.includes("v0.235｜") ||
  !changelog.includes("v0.235") ||
  !settingsHtml.includes("v0.235") ||
  !historyHtml.includes("v0.235") ||
  !analysisHtml.includes("v0.235")
) {
...
if (
  !html.includes('href="/styles.css?v=0.235"') ||
