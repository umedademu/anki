...
if (!html.includes('<script src="/app.js?v=0.228" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.228") ||
  !app.includes("v0.228｜") ||
  !changelog.includes("v0.228") ||
  !settingsHtml.includes("v0.228") ||
  !historyHtml.includes("v0.228") ||
  !analysisHtml.includes("v0.228")
) {
...
if (
  !html.includes('href="/styles.css?v=0.228"') ||
