...
if (!html.includes('<script src="/app.js?v=0.242" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.242") ||
  !app.includes("v0.242｜") ||
  !changelog.includes("v0.242") ||
  !settingsHtml.includes("v0.242") ||
  !historyHtml.includes("v0.242") ||
  !analysisHtml.includes("v0.242")
) {
...
if (
  !html.includes('href="/styles.css?v=0.242"') ||
