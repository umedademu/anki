...
if (!html.includes('<script src="/app.js?v=0.232" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.232") ||
  !app.includes("v0.232｜") ||
  !changelog.includes("v0.232") ||
  !settingsHtml.includes("v0.232") ||
  !historyHtml.includes("v0.232") ||
  !analysisHtml.includes("v0.232")
) {
...
if (
  !html.includes('href="/styles.css?v=0.232"') ||
