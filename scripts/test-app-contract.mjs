...
if (!html.includes('<script src="/app.js?v=0.233" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.233") ||
  !app.includes("v0.233｜") ||
  !changelog.includes("v0.233") ||
  !settingsHtml.includes("v0.233") ||
  !historyHtml.includes("v0.233") ||
  !analysisHtml.includes("v0.233")
) {
...
if (
  !html.includes('href="/styles.css?v=0.233"') ||
