...
if (!html.includes('<script src="/app.js?v=0.236" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.236") ||
  !app.includes("v0.236｜") ||
  !changelog.includes("v0.236") ||
  !settingsHtml.includes("v0.236") ||
  !historyHtml.includes("v0.236") ||
  !analysisHtml.includes("v0.236")
) {
...
if (
  !html.includes('href="/styles.css?v=0.236"') ||
