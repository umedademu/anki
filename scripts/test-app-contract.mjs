...
if (!html.includes('<script src="/app.js?v=0.261" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.261") ||
  !app.includes("app-navigation.js?v=0.261") ||
  !changelog.includes("v0.261") ||
  !settingsHtml.includes("v0.261") ||
  !historyHtml.includes("v0.261") ||
  !analysisHtml.includes("v0.261")
) {
...
if (
  !html.includes('href="/styles.css?v=0.261"') ||
