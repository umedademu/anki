...
if (!html.includes('<script src="/app.js?v=0.198" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.198") ||
  !app.includes("v0.198｜") ||
  !changelog.includes("v0.198") ||
  !settingsHtml.includes("v0.198") ||
  !historyHtml.includes("v0.198") ||
  !analysisHtml.includes("v0.198")
) {
...
if (
  !html.includes('href="/styles.css?v=0.198"') ||
