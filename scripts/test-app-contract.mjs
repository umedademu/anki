...
if (!html.includes('<script src="/app.js?v=0.204" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.204") ||
  !app.includes("v0.204｜") ||
  !changelog.includes("v0.204") ||
  !settingsHtml.includes("v0.204") ||
  !historyHtml.includes("v0.204") ||
  !analysisHtml.includes("v0.204")
) {
...
if (
  !html.includes('href="/styles.css?v=0.204"') ||
