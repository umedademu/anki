...
if (!html.includes('<script src="/app.js?v=0.209" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.209") ||
  !app.includes("v0.209｜") ||
  !changelog.includes("v0.209") ||
  !settingsHtml.includes("v0.209") ||
  !historyHtml.includes("v0.209") ||
  !analysisHtml.includes("v0.209")
) {
...
if (
  !html.includes('href="/styles.css?v=0.209"') ||
