...
if (!html.includes('<script src="/app.js?v=0.187" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.187") ||
  !app.includes("v0.187｜") ||
  !changelog.includes("v0.187") ||
  !settingsHtml.includes("v0.187") ||
  !historyHtml.includes("v0.187") ||
  !analysisHtml.includes("v0.187")
) {
...
if (
  !html.includes('href="/styles.css?v=0.187"') ||
