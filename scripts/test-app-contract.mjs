...
if (!html.includes('<script src="/app.js?v=0.195" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.195") ||
  !app.includes("v0.195｜") ||
  !changelog.includes("v0.195") ||
  !settingsHtml.includes("v0.195") ||
  !historyHtml.includes("v0.195") ||
  !analysisHtml.includes("v0.195")
) {
...
if (
  !html.includes('href="/styles.css?v=0.195"') ||
