...
if (!html.includes('<script src="/app.js?v=0.270" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.270") ||
  !app.includes("app-navigation.js?v=0.270") ||
  !changelog.includes("v0.270") ||
  !settingsHtml.includes("v0.270") ||
  !historyHtml.includes("v0.270") ||
  !analysisHtml.includes("v0.270")
) {
...
if (
  !html.includes('href="/styles.css?v=0.270"') ||
