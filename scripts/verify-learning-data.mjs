...
if (
  ...
  mindsetSubjectEntry.termCount !== 118 ||
...
if (
  ...
  new Set(generatedMindsetTerms.map((term) => term.id)).size !== 118 ||
  new Set(generatedMindsetTerms.map((term) => term.content)).size !== 118 ||
  ...
  throw new Error("マインドセット118件の生成内容が元データと一致しません。");
}
