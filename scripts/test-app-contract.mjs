...
if (!html.includes('<script src="/app.js?v=0.248" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.248") ||
  !app.includes("app-navigation.js?v=0.248") ||
  !changelog.includes("v0.248") ||
  !settingsHtml.includes("v0.248") ||
  !historyHtml.includes("v0.248") ||
  !analysisHtml.includes("v0.248")
) {
...
if (
  !html.includes('href="/styles.css?v=0.248"') ||
