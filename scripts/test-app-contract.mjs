...
if (!html.includes('<script src="/app.js?v=0.277" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.277") ||
  !app.includes("app-navigation.js?v=0.277") ||
  !changelog.includes("v0.277") ||
  !settingsHtml.includes("v0.277") ||
  !historyHtml.includes("v0.277") ||
  !analysisHtml.includes("v0.277")
) {
...
if (
  !html.includes('href="/styles.css?v=0.277"') ||
