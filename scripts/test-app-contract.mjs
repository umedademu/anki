...
if (!html.includes('<script src="/app.js?v=0.219" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.219") ||
  !app.includes("v0.219｜") ||
  !changelog.includes("v0.219") ||
  !settingsHtml.includes("v0.219") ||
  !historyHtml.includes("v0.219") ||
  !analysisHtml.includes("v0.219")
) {
...
if (
  !html.includes('href="/styles.css?v=0.219"') ||
