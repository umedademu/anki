...
if (!html.includes('<script src="/app.js?v=0.184" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.184") ||
  !app.includes("v0.184｜") ||
  !changelog.includes("v0.184") ||
  !settingsHtml.includes("v0.184") ||
  !historyHtml.includes("v0.184") ||
  !analysisHtml.includes("v0.184")
) {
...
if (
  !html.includes('href="/styles.css?v=0.184"') ||
