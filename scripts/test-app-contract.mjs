...
if (!html.includes('<script src="/app.js?v=0.258" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.258") ||
  !app.includes("app-navigation.js?v=0.258") ||
  !changelog.includes("v0.258") ||
  !settingsHtml.includes("v0.258") ||
  !historyHtml.includes("v0.258") ||
  !analysisHtml.includes("v0.258")
) {
...
if (
  !html.includes('href="/styles.css?v=0.258"') ||
