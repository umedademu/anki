...
if (!html.includes('<script src="/app.js?v=0.193" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.193") ||
  !app.includes("v0.193｜") ||
  !changelog.includes("v0.193") ||
  !settingsHtml.includes("v0.193") ||
  !historyHtml.includes("v0.193") ||
  !analysisHtml.includes("v0.193")
) {
...
if (
  !html.includes('href="/styles.css?v=0.193"') ||
