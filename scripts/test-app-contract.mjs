...
if (!html.includes('<script src="/app.js?v=0.206" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.206") ||
  !app.includes("v0.206｜") ||
  !changelog.includes("v0.206") ||
  !settingsHtml.includes("v0.206") ||
  !historyHtml.includes("v0.206") ||
  !analysisHtml.includes("v0.206")
) {
...
if (
  !html.includes('href="/styles.css?v=0.206"') ||
