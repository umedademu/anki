...
if (!html.includes('<script src="/app.js?v=0.249" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.249") ||
  !app.includes("app-navigation.js?v=0.249") ||
  !changelog.includes("v0.249") ||
  !settingsHtml.includes("v0.249") ||
  !historyHtml.includes("v0.249") ||
  !analysisHtml.includes("v0.249")
) {
...
if (
  !html.includes('href="/styles.css?v=0.249"') ||
