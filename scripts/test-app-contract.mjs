...
if (!html.includes('<script src="/app.js?v=0.257" type="module"></script>')) {
...
if (
  ...
  !html.includes("v0.257") ||
  !app.includes("app-navigation.js?v=0.257") ||
  !changelog.includes("v0.257") ||
  !settingsHtml.includes("v0.257") ||
  !historyHtml.includes("v0.257") ||
  !analysisHtml.includes("v0.257")
) {
...
if (
  !html.includes('href="/styles.css?v=0.257"') ||
